...
int Ver_Primero_Cola_Circular(const t_cola *pc, t_dato *pd)
{
    if(*pc==NULL)
    {
        printf("\n\nLa cola esta vacia.\n");
...
int main()
{
    ...
    printf("\n\nVeremos el primero de la cola circular.");
    if(Ver_Primero_Cola_Circular(&cola,&d))
    {
        printf("\n\nEl primero de la cola circular es: %d\n", d.dato);
    }
    return 0;
}
