...
int Insertar_En_Orden_Lista_Doble(t_lista *pl, const t_dato *pd)
{
    t_nodo *pact=*pl, *ant, *sig, *pnue;
    int cmp;
    if(pact)
    {
...
int main()
{
    ...
    printf("\n\nMostraremos la lista ordenada: ");
    Mostrar_Lista_Doble(&lista);
    printf("\n\nInsertaremos un numero en la lista.\nIngrese el numero a insertar: ");
    scanf("%d",&d.dato);
    Insertar_En_Orden_Lista_Doble(&lista,&d);
