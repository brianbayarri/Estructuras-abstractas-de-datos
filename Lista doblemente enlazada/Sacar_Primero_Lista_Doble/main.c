...
int Sacar_Primero_Lista_Doble(t_lista *pl, t_dato *pd)
{
    t_nodo *pact=*pl;
    if(pact==NULL)
    {
...
int main()
{
    ...
    printf("\n\nAhora sacaremos el primer dato de la lista.");
    Sacar_Primero_Lista_Doble(&lista,&d);
    printf("\n\nEl dato que se encontraba al principio de la lista es: %d.", d.dato);
